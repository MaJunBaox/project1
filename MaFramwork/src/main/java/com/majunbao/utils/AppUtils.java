...
public final class AppUtils {
    ...
    public static boolean isInstallApp(final String action, final String category) {
        ...
        PackageManager pm = AndroidUtils.getApp().getPackageManager();
    ...
    public static void installApp(final File file, final String authority) {
        ...
        AndroidUtils.getApp().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        AndroidUtils.getApp().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
    ...
    public static void launchApp(final String packageName) {
        ...
        AndroidUtils.getApp().startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = AndroidUtils.sActivityList;
    ...
    public static String getAppPackageName() {
        return AndroidUtils.getApp().getPackageName();
    }
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName) {
        ...
        AndroidUtils.getApp().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName, true));
    }
    ...
    public static String getAppName() {
        return getAppName(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(AndroidUtils.getApp().getPackageName());
    }
...
/*    public static String getAppSignatureSHA1(final String packageName) {
    ...
    public static boolean isAppForeground() {
        ActivityManager manager =
                (ActivityManager) AndroidUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(AndroidUtils.getApp().getPackageName());
            }
        }
        return false;
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(AndroidUtils.getApp().getPackageName());
    }
