...
public final class ActivityManager {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(AndroidUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(AndroidUtils.getApp().getPackageManager()) == null ||
                AndroidUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static List<Activity> getActivityList() {
        return AndroidUtils.sActivityList;
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(AndroidUtils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        if (AndroidUtils.sTopActivityWeakRef != null) {
            Activity activity = AndroidUtils.sTopActivityWeakRef.get();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = AndroidUtils.sActivityList;
    ...
    public static Drawable getActivityIcon(final Class<?> clz) {
        return getActivityIcon(new ComponentName(AndroidUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(final Class<?> clz) {
        return getActivityLogo(new ComponentName(AndroidUtils.getApp(), clz));
    }
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? AndroidUtils.getApp() : topActivity;
    }
